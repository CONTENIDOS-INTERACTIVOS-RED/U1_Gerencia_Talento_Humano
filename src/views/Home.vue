        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 El talento humano abarca a los colaboradores y al área encargada de su desarrollo dentro de una organización. Su gestión incluye selección, formación y evaluación del desempeño, garantizando ambientes laborales productivos. Las nuevas generaciones priorizan la flexibilidad y bienestar. La planificación estratégica y el modelo de gestión por competencias optimizan el rendimiento. Un enfoque integral fomenta la retención de talento y el alineamiento con la misión empresarial, asegurando sostenibilidad y crecimiento organizacional.
